...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={inter.className + " bg-zinc-900 text-zinc-50 text-xs"}>
        <div className="flex flex-col min-h-screen p-8">
          <header className="leading-relaxed mb-8">
            Get started by editing{" "}
            <code className="text-orange-300">src/app/page.tsx</code> and{" "}
            <code className="text-orange-300">src/app/layout.tsx</code>.
            <br />
            If you see text below, that means you are successfully getting data
            from the API backend.
          </header>
          <div className="flex-grow">{children}</div>
          <footer className="border-t border-zinc-800 pt-2 mt-8 text-zinc-400">
            <Link href={"https://tesselate.ai"}>
              <svg
